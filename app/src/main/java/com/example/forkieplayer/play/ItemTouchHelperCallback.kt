...
class ItemTouchHelperCallback(private val playAdapter: PlayAdapter) : ItemTouchHelper.Callback() {
    ...
    override fun onMove(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, target: RecyclerView.ViewHolder): Boolean {
        ...
        playAdapter.moveItem(fromPos, toPos)
        return true
    }
    ...
    private fun clampViewPositionHorizontal(
        ...
        return kotlin.math.min(max(min, x), max)
    }
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) : View {
        return (viewHolder as PlayAdapter.PlayViewHolder).itemView.findViewById<LinearLayout>(R.id.layout_play)
    }
